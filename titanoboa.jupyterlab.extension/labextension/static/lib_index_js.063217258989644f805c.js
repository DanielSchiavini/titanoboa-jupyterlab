"use strict";
(self["webpackChunktitanoboa_jupyterlab_extension"] = self["webpackChunktitanoboa_jupyterlab_extension"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'titanoboa.jupyterlab.extension', // API Namespace
    endPoint);
    let response;
    try {
...
const plugin = {
    ...
    activate: (app) => {
        ...
        (0,_handler__WEBPACK_IMPORTED_MODULE_0__.requestAPI)('get_example')
            ...
            .catch(reason => {
            console.error(`The titanoboa.jupyterlab.extension server extension appears to be missing.\n${reason}`);
        });
    }
};
...
//# sourceMappingURL=lib_index_js.063217258989644f805c.js.map